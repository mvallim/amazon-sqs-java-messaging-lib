...
public class AmazonSqsTemplate<E> extends AbstractAmazonSqsTemplate<SendMessageBatchRequest, SendMessageBatchResponse, E> {
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} instead
   *
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} and {@link Builder#publishDecorator(UnaryOperator)} instead
   *
   * @param amazonSqsClient  the AWS SDK v2 SQS client
   * @param queueProperty    the queue configuration properties
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} and {@link Builder#queueRequests(BlockingQueue)} instead
   *
   * @param amazonSqsClient the AWS SDK v2 SQS client
   * @param queueProperty   the queue configuration properties
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} with {@link Builder#queueRequests(BlockingQueue)} and {@link Builder#publishDecorator(UnaryOperator)} instead
   *
   * @param amazonSqsClient  the AWS SDK v2 SQS client
   * @param queueProperty    the queue configuration properties
   * @param queueRequests    the blocking queue for incoming requests
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} and {@link Builder#objectMapper(ObjectMapper)} instead
   *
   * @param amazonSqsClient the AWS SDK v2 SQS client
   * @param queueProperty   the queue configuration properties
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} with {@link Builder#objectMapper(ObjectMapper)} and {@link Builder#publishDecorator(UnaryOperator)} instead
   *
   * @param amazonSqsClient  the AWS SDK v2 SQS client
   * @param queueProperty    the queue configuration properties
   * @param objectMapper     the JSON object mapper
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} with {@link Builder#queueRequests(BlockingQueue)} and {@link Builder#objectMapper(ObjectMapper)} instead
   *
   * @param amazonSqsClient the AWS SDK v2 SQS client
   * @param queueProperty   the queue configuration properties
   * @param queueRequests   the blocking queue for incoming requests
   ...
   *
   * @deprecated since 1.3.0, use {@link #builder(SqsClient, QueueProperty)} with builder setters instead
   *
   * @param amazonSqsClient  the AWS SDK v2 SQS client
   * @param queueProperty    the queue configuration properties
   * @param queueRequests    the blocking queue for incoming requests
